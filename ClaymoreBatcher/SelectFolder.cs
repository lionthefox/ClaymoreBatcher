        ...
        private void button1_Click(object sender, EventArgs e)
        {
            using (var folderDialog = new FolderBrowserDialog())
            {
                ...
                var items = new[]
                {
                    ...
                    new Parameter("epsw","Password for Ethereum pool, use 'x' as password."),
                    new Parameter("eworker", "Worker name, it is required for some pools."),
                    new Parameter("ewal",
                    ...
                    new Parameter("esm",
                        ...
                        "1234"),
                    new Parameter("etha","Ethereum algorithm mode for AMD cards. 0 - optimized for fast cards, 1 - optimized for slow cards, 2 - for gpu-pro Linux drivers. -1 - autodetect (default, automatically selects between 0 and 1).You can also set this option for every card individually, for example '-etha 0,1,0'.", "-1012" ),
                    ...
                    new Parameter("oldkernels", "(AMD cards only) specify '-oldkernels 1' to use old-style GPU kernels from v10, they can be more stable for hard OC and custom BIOSes."),
