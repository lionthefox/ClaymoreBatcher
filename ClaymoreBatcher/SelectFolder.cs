        ...
        private void button1_Click(object sender, EventArgs e)
        {
            using (var folderDialog = new FolderBrowserDialog())
            {
                ...
                {  // TO DO: change rangeTypes
                    ...
                    new Parameter("ewal",
                        "Your Ethereum wallet address. Also worker name and other options if pool supports it. Pools that require 'Login.Worker' instead of wallet address are not supported directly currently, but you can use '-allpools 1' option to mine there.", RangeType.NoRange),
                    new Parameter("esm",
